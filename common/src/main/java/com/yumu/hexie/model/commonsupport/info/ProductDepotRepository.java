...
public interface ProductDepotRepository extends JpaRepository<ProductDepot, Long> {
    ...
    String sqlColumn1 = " a.id,a.name,a.createDate,a.mainPicture,a.smallPicture,a.pictures,a.miniPrice,a.oriPrice,a.singlePrice,a.serviceDesc,a.totalCount,a.ownerName as userName, a.areaLimit, count(DISTINCT d.id) as groupCount, count(distinct f.orderId) as orderNum ";
