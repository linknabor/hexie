package com.yumu.hexie.model.commonsupport.cache;
 ...
 *
 */
public class ProductRuleCache implements Serializable {
	...
	public <T extends SalePlan> ProductRuleCache(Product product, T salePlan) {
